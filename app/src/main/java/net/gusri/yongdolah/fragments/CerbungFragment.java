...
/**
 * Created by ghostonk on 21/12/16.
 */

public class CerbungFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("Blog").orderByChild("category").equalTo("Cerbung");
    ...
    public static class BlogViewHolder extends RecyclerView.ViewHolder {
        ...
        public BlogViewHolder(View itemView) {
           ...
           /* mDBViewer = FirebaseDatabase.getInstance().getReference().child("Viewers");
            mDBViewer.keepSynced(true);*/

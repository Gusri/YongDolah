...
/**
 * Created by ghostonk on 14/12/16.
 */

public class HomeFragment extends Fragment {
    private RecyclerView mBlogList;
    private DatabaseReference mDatabase, mDBLike, mDBSmile;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View mView = inflater.inflate(R.layout.view_blog, container, false);
    ...
    public static class BlogViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setImage(final Context context, final String image) {
            ...
            Glide.with(context).load(image).placeholder(R.drawable.no_img).fitCenter().thumbnail(0.1f).crossFade()
